...
class YOLOv8:
    """
    YOLOv8 is a wrapper class designed for object detection using a Ultralytics YOLO-based model.
    ...
    def __init__(
        ...
        """
        Initializes the YOLOv8 class with model input details and thresholds.
